python3 train_for_all_1.py --config configs/few-shot-setting/Template-BBDM-tfbind10-rand.yaml \
&python3 train_for_all_1.py --config configs/few-shot-setting/Template-BBDM-dkitty-rand.yaml 
